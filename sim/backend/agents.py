...
PERSONALITY_ACTION_WEIGHTS: dict[str, dict[ActionType, float]] = {
    ...
    "agreeableness": {
        ...
        ActionType.KILL: -0.9, ActionType.BULLY: -0.7,
    },
    "neuroticism": {
...
GOAL_ACTION_MAP: dict[str, list[ActionType]] = {
    ...
    "power": [ActionType.COMPETE, ActionType.ATTACK, ActionType.ALLY, ActionType.KILL],
    "dominate": [ActionType.ATTACK, ActionType.COMPETE, ActionType.BETRAY, ActionType.BULLY],
    "knowledge": [ActionType.EXPLORE, ActionType.OBSERVE, ActionType.COMMUNICATE, ActionType.LEARN],
    "learn": [ActionType.EXPLORE, ActionType.OBSERVE, ActionType.COMMUNICATE, ActionType.LEARN],
    ...
    "survive": [ActionType.GATHER, ActionType.DEFEND, ActionType.REST, ActionType.BUILD_HOME],
    "survival": [ActionType.GATHER, ActionType.DEFEND, ActionType.REST, ActionType.BUILD_HOME],
    "influence": [ActionType.NEGOTIATE, ActionType.ALLY, ActionType.COMMUNICATE, ActionType.TEACH],
    "friendship": [ActionType.COOPERATE, ActionType.SHARE, ActionType.COMMUNICATE, ActionType.COURT],
    "revenge": [ActionType.ATTACK, ActionType.BETRAY, ActionType.COMPETE, ActionType.KILL],
    ...
    "justice": [ActionType.DEFEND, ActionType.COOPERATE, ActionType.COMMUNICATE],
...
MOTIVATION_ACTION_MAP: dict[str, dict[ActionType, float]] = {
    ...
    "ambition": {ActionType.COMPETE: 0.6, ActionType.NEGOTIATE: 0.5, ActionType.ALLY: 0.4, ActionType.REST: -0.3, ActionType.LEARN: 0.4},
    "fear": {ActionType.DEFEND: 0.7, ActionType.REST: 0.4, ActionType.OBSERVE: 0.5, ActionType.ATTACK: -0.5},
    "loyalty": {ActionType.COOPERATE: 0.6, ActionType.ALLY: 0.7, ActionType.DEFEND: 0.5, ActionType.BETRAY: -0.8, ActionType.KILL: -0.6},
    "curiosity": {ActionType.EXPLORE: 0.8, ActionType.OBSERVE: 0.6, ActionType.COMMUNICATE: 0.5, ActionType.LEARN: 0.7},
    "compassion": {ActionType.SHARE: 0.7, ActionType.COOPERATE: 0.6, ActionType.TEACH: 0.5, ActionType.ATTACK: -0.6, ActionType.BETRAY: -0.7, ActionType.KILL: -0.9, ActionType.BULLY: -0.8},
    "pride": {ActionType.COMPETE: 0.6, ActionType.DEFEND: 0.5, ActionType.COOPERATE: -0.2, ActionType.BUILD_HOME: 0.4},
    "vengeance": {ActionType.ATTACK: 0.7, ActionType.BETRAY: 0.5, ActionType.COMPETE: 0.4, ActionType.KILL: 0.6, ActionType.SHARE: -0.5},
    "survival": {ActionType.GATHER: 0.6, ActionType.DEFEND: 0.6, ActionType.REST: 0.5, ActionType.BUILD_HOME: 0.5, ActionType.EXPLORE: -0.2},
    "diplomacy": {ActionType.NEGOTIATE: 0.7, ActionType.COMMUNICATE: 0.6, ActionType.ALLY: 0.5, ActionType.ATTACK: -0.5, ActionType.KILL: -0.7},
    "honor": {ActionType.DEFEND: 0.6, ActionType.COOPERATE: 0.5, ActionType.BETRAY: -0.7, ActionType.BULLY: -0.6, ActionType.KILL: -0.4},
    "love": {ActionType.COURT: 0.8, ActionType.SHARE: 0.5, ActionType.COOPERATE: 0.4, ActionType.ATTACK: -0.4},
...
EMOTION_ACTION_MAP: dict[str, dict[ActionType, float]] = {
    ...
    "anger": {
        ...
        ActionType.BULLY: 0.5, ActionType.KILL: 0.4,
        ActionType.COOPERATE: -0.4, ActionType.SHARE: -0.3, ActionType.COURT: -0.3,
    },
    "fear": {
        ActionType.DEFEND: 0.7, ActionType.REST: 0.4, ActionType.OBSERVE: 0.5,
        ActionType.ATTACK: -0.5, ActionType.EXPLORE: -0.3, ActionType.KILL: -0.3,
    },
    "trust": {
        ActionType.COOPERATE: 0.6, ActionType.ALLY: 0.7, ActionType.SHARE: 0.5,
        ActionType.NEGOTIATE: 0.4, ActionType.COURT: 0.3, ActionType.TEACH: 0.3,
        ActionType.BETRAY: -0.6, ActionType.ATTACK: -0.3,
    },
    "sadness": {
        ActionType.REST: 0.6, ActionType.OBSERVE: 0.4,
        ActionType.COMMUNICATE: -0.3, ActionType.COMPETE: -0.3, ActionType.COURT: -0.4,
    },
    "disgust": {
        ActionType.COMPETE: 0.3, ActionType.DEFEND: 0.3, ActionType.BULLY: 0.2,
